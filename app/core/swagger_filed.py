...
class IntegerQueryFiled(ParamFiled):
    def __init__(self, name, description, enum=None, required=None, default=None):
        super(name, 'query', 'integer', description, enum, required, default).__init__()


class IntegerPathFiled(ParamFiled):
    def __init__(self, name, description, enum=None, required=None, default=None):
        super(name, 'path', 'integer', description, enum, required, default).__init__()


class StringQueryFiled(ParamFiled):
    def __init__(self, name, description, enum=None, required=None, default=None):
        super(name, 'query', 'string', description, enum, required, default).__init__()


class StringPathFiled(ParamFiled):
    def __init__(self, name, description, enum=None, required=None, default=None):
        super(name, 'path', 'string', description, enum, required, default).__init__()


class BooleanQueryFiled(ParamFiled):
    def __init__(self, name, description, enum=None, required=None, default=None):
        super(name, 'query', 'boolean', description, enum, required, default).__init__()


class BooleanPathFiled(ParamFiled):
    def __init__(self, name, description, enum=None, required=None, default=None):
        super(name, 'path', 'boolean', description, enum, required, default).__init__()
